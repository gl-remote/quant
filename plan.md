...
**结论**：机械搬运（建 run / 接 persister / finalizer）不难，但需先补 bridge 数据缺口，否则只是接空壳。详细方案见 [backtest-refactor-plan.md 阶段 10](file:///Users/gaolei/Documents/src/quant/docs/roadmap/backtest-refactor-plan.md#L1506-L1534)。
