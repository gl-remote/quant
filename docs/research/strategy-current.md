...
> 状态：**活跃主题：time-barrier-selection（2026-07-28 立题）** · 单合约持仓周期 $T$ 决策研究 · mean-reversion-barrier-duality 已于 2026-08-02 冻结（数学内核沉淀为 `theorem:structural-shaping-alpha#factor-filtering-and-dgp-boundary`，方向性单品种 $R<1$ 可交易性被怀疑先验否证）
> 最近更新：2026-08-02
...
```text
2026-08-02 · mean-reversion-barrier-duality 主题冻结：
阶段 0（OU 合成数据 + 小 κ 闭式）+ 讨论深化后，数学内核已沉淀为
theorem:structural-shaping-alpha#factor-filtering-and-dgp-boundary，
方向性单品种 R<1 可交易性被怀疑先验否证（可交易尺度 κ≈0/H>0.5，
唯一 κ 够大的微结构尺度不可交易），不进入真实数据阶段 1。
冻结摘要：archive:2026-08-02-mean-reversion-barrier-duality-freeze。
真正可能成立的形态（市场中性配对/事件短窗/微结构）已偏离原问题域，
若重启需另立主题。
```
...
| 主题 | 状态 | 文档 |
| --- | --- | --- |
| ~~volume-spike-regime-shift~~ | **已冻结归档（2026-08-05）** · 1h 成交量放量 × MADEV 均线回归 · 独立 alpha 证伪，适合作为趋势持仓减仓过滤器；蒸馏为因子库 `factor-library/volume-spike` | [archive:2026-08-05-volume-spike-regime-shift](./archived-notes/2026/08/2026-08-05-volume-spike-regime-shift/freeze-summary.md) |
| ~~mean-reversion-barrier-duality~~ | **已冻结归档（2026-08-02）** · 数学内核沉淀至 `theorem:structural-shaping-alpha#factor-filtering-and-dgp-boundary` · 方向性单品种 $R<1$ 可交易性被怀疑先验否证 | [archive:2026-08-02-mean-reversion-barrier-duality-freeze](../research/archived-notes/2026/08/2026-08-02-mean-reversion-barrier-duality-freeze/freeze-summary.md) |
...
| ~~structural-shaping-alpha~~ | **冻结归档（2026-07-24）** · 主命题四阶段完成 · 通道 A/B 双通道兑现 · KF-27 参数优化器交付 · 稳定数学契约提炼至 [theorems/theory-library/structural-shaping-alpha/](./theorems/theory-library/structural-shaping-alpha/README.md) | [archive:2026-07-24-structural-shaping-alpha-freeze](../research/archived-notes/2026/07/2026-07-24-structural-shaping-alpha-freeze/freeze-summary.md) |
...
- 塑形工具资产（**已归档**）：`archive:2026-07-24-structural-shaping-alpha-freeze`（稳定数学契约见 [theorems/theory-library/structural-shaping-alpha/](./theorems/theory-library/structural-shaping-alpha/README.md)）
...
2. **同步维护**塑形工具资产（structural-shaping-alpha 已冻结归档，稳定数学契约在 [theorems/theory-library/structural-shaping-alpha/](./theorems/theory-library/structural-shaping-alpha/README.md)）
...
| structural-shaping-alpha（塑形工具资产 · **已归档**） | [archive:2026-07-24-structural-shaping-alpha-freeze](../research/archived-notes/2026/07/2026-07-24-structural-shaping-alpha-freeze/freeze-summary.md) · [theorems/theory-library/structural-shaping-alpha/](./theorems/theory-library/structural-shaping-alpha/README.md) |
