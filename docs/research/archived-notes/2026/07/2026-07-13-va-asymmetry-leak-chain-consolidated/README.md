...
- **搬入前**：7 个子批次分散在 `docs/research/archived-notes/2026/07/2026-07-XX-*/`
- **搬入后**：全部位于 `docs/research/archived-notes/2026/07/2026-07-13-va-asymmetry-leak-chain-consolidated/<sub-batch>/`
