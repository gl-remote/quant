...
- 相关文件：archive:2026/07/structural-shaping-alpha-stage1#stage-summary
...
- archive:2026/06/indicator-baseline（指标基线，已被后续 structural-alpha
  批次取代）；
- archive:2026/06/low-validation-cost（低验证成本策略批次，属于独立策略
  家族，与本主题无假设/数据/代码交集）。
