...
- **旧版 v1.0（B0 = S1×W0×VW0 冻结版）已整目录归档**至
  `../../archive/strategy-research/2026/07/2026-07-10-va-asymmetry-composite/`。
...
`../../archive/strategy-research/2026/07/2026-07-10-va-asymmetry-composite/strategy-math-spec.md`。
