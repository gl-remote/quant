...
**C · 分类器性能**：Sharpe 全部 +6~+15 · MDD 177-864 bps
...
**A 级 · 可直接用于阶段 4 或其他策略**（5 档）：
1. **多头宽松·稳定**（性价比之王 · Sharpe 14.9 · 触发 966/年）⭐
2. **多头首选·全**（最强单笔 · IR 0.577 · Sharpe 14.1）
3. **多头首选·转换**（Bonferroni ✅ · Sharpe 11）
4. **空头首选·稳定** or **空头收敛·稳定**（二选一 · 高度重叠 · 推荐收敛）
5. **空头宽松·稳定**（Sharpe 12.9 · 触发 1204/年 · 高频空头）
