...
- **A 级白名单**（阶段 4 优先使用）：
  - 多头首选·全事件（IR/trade 0.577 · Sharpe 14.1）
  - **多头宽松·稳定**（性价比之王 · Sharpe 14.9 · 触发 966/年）⭐
  - 空头首选·稳定 or 空头收敛·稳定（Sharpe 11-11.4 · 二选一 · Jaccard 0.76 高度重叠）
  - 空头宽松·稳定（Sharpe 12.9 · 触发 1204/年 · 高频空头）
