...
叠加 structural-shaping-alpha 工具 + archive:2026/07/poc-va-shaping 塑形参数，
...
> 以下方向 A/B/C 已部分在 archive:2026/07/poc-va-shaping 与 va-asymmetry-composite 立题中承接：
> - archive:2026/07/poc-va-shaping 完成"方向 B（完整策略）"的塑形 POC 验证（SL1.0/TP1.4/TH8h + c_realistic → 净 15.45% / Sharpe 2.23）
