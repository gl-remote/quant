...
`docs/archive/strategy-research/2026-07-03-value-area-reacceptance-stage-b/stage-b-sweep-summary.md`
...
def aggregate_and_write(db_path: str) -> Path:  # noqa: C901
    ...
    # docs/archive/strategy-research/2026-07-03-value-area-reacceptance-stage-b/。
