...
主题 `value-area-rolling-reacceptance` 冻结归档。
...
Rolling POC 假设失败，reacceptance 触发器非特殊，4+ ATR 距离档 baseline
期望 ≈ 0；主题冻结，方法论资产（ATR 归一化 / 期望净值判据 / 多层对照 /
cluster bootstrap）沿用到后续主题。
