...
> 开分支 hash：630296b  
> 实现提交 hash：5a553c9  
> 关联文档：[strategy-atr-tuning.md](../strategy-research/2026/06/indicator-baseline/strategy-atr-tuning.md)  
...
本问题是在 [strategy-atr-tuning.md](../strategy-research/2026/06/indicator-baseline/strategy-atr-tuning.md) 的 P1.5 信号密度重构过程中发现的框架层缺陷。
