...
- [随机对照阶段摘要](../archive/strategy-research/2026-06-29-structural-alpha-random-baseline/random-baseline-experiment-summary.md)
- [raw workbench: r3 entry routes loop](../archive/strategy-research/2026-06-29-structural-alpha-random-baseline/raw-workbench/structural-alpha-random-baseline-r3-entry-routes-loop.md)
