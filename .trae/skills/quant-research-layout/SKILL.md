...
archive 顶层索引 [`docs/archive/strategy-research/README.md`](../../archive/strategy-research/README.md) 的"家族 slug"列用于分类归档批次；"日期"列即 `archive:` 前缀日期段的解析源；两者共同构成命名引用的**权威索引表**。
