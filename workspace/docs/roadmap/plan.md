...
> 版本: 0.4.0-dev | 最后更新: 2026-06-23 | 主线: 新策略探索与多窗口验证
>
...
**结论**：机械搬运（建 run / 接 persister / finalizer）不难，但需先补 bridge 数据缺口，否则只是接空壳。详细方案见 [backtest-refactor-plan.md 阶段 10](file:///Users/gaolei/Documents/src/quant/workspace/docs/archive/backtest-refactor-plan.md#L1506-L1534)。
