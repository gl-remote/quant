...
- 本目录定位与 [directory-roadmap.md](../../../docs/roadmap/directory-roadmap.md) 中 `workspace/packages/contracts/` 一致：跨业务域、跨语言、跨运行单元。
...
- [backtest-refactor-plan.md 阶段 0.5](../../../docs/roadmap/backtest-refactor-plan.md)
- [directory-roadmap.md 原则 4 跨语言契约](../../../docs/roadmap/directory-roadmap.md)
