...
class TestWithCooldownAfterTakeProfit:
    ...
    def test_blocks_entry_inside_cooldown(self) -> None:
        ...
        assert ctx.aspects.risk.take_profit.entry_block[0].detail["cooldown_minutes"] == 10.0
        assert ctx.aspects.risk.take_profit.entry_block[0].detail["remaining_seconds"] == 300.0
